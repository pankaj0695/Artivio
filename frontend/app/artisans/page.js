...
export default function ArtisansDirectoryPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="mb-8">
        <h1 className="text-4xl font-bold text-gray-900 mb-3">Artisans</h1>
        <p className="text-gray-600">Discover makers and explore their storefronts</p>
      </div>

      <div className="bg-white rounded-2xl shadow-sm border p-4 mb-8">
        <Input
          placeholder="Search artisans by name, craft, or materials..."
          value={q}
      ...
      {loading ? (
        ...
        <div className="text-gray-600">No artisans found.</div>
      ) : (
                ...
                <CardContent className="p-4">
                  <div className="flex items-center gap-3">
                    <div className="relative w-12 h-12 -mt-10 rounded-full border-2 border-white overflow-hidden bg-gray-100">
                      <Image
                        src={a.avatar || "/default-avatar.svg"}
                        alt={a.displayName || ""}
                        fill
                    ...
                    <div>
                      <div className="font-semibold">{a.displayName || "Untitled"}</div>
                      {a.tagline && (
